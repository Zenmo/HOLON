...
class AnyLogicExperiment:
    ...
    def setInputs(self):
        ...
        self.inputs.set_input('P grid connection config JSON', self.experiment.gridConnectionConfigData)
        self.inputs.set_input('P grid node config JSON', self.experiment.gridNodeConfigData) 
        self.inputs.set_input('P energy assets config JSON', self.experiment.energyAssetConfigData)
    ...
    def runSimulation(self):
        ...
        df_nested_list.to_excel(self.experiment.path+"\\"+"outputAPI_"+self.experiment.name+".xlsx")
